...
$title = ucfirst($_SESSION['Role']) . " Organizational List|| " . SITE_TITLE;
                ...
                if ($organizationList) {
                    foreach ($organizationList as $key => $details) {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="<?php echo CMS_URL . '/' . lcfirst($_SESSION['Role']) . '/organizationalAdd.php?id=' . $details->OrganizationId; ?>" style="border-radius:50%" class="btn btn-success">
                                    <i class="fa fa-edit"></i></a>
                                <a href="<?php echo ADMIN_RENDER . '/common/organizational.php?id=' . $details->OrganizationId.'&&Action=Delete';?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this orgainzation?')" style="border-radius: 50%">
