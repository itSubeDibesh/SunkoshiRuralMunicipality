...
$title = ucfirst($_SESSION['Role']) . " Update Complain || " . SITE_TITLE;
...
if (isset($_GET, $_GET['id']) && !empty($_GET['id'])) {
    ...
    redirect(CMS_URL . '/' . lcfirst($_SESSION['Role']) . '/complainList.php', 'error', 'Unauthorized access');
}
?>
<div class="col-md-12">
    <div class="overview-wrap">
        <h2 class="title-1"></h2>
        <a class="au-btn au-btn-icon au-btn--blue" style="color:aliceblue" href="<?php echo CMS_URL . '/' . lcfirst($_SESSION['Role']) . '/complainList.php' ?>">
            <i class="fa fa-chevron-circle-left"></i> Back to complain list</a>
    </div>
</div>
<br>
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h3><?php echo $action ?> complain</h3>
        </div>
