...
$title = ucfirst($_SESSION['Role']) . " Problem List || " . SITE_TITLE;
                    ...
                    foreach ($ProblemList as $key => $variableList) {
                        if ($variableList->Status != 'Solved') {
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="<?php echo CMS_URL . '/' . lcfirst($_SESSION['Role']) . '/problemUpdate.php?id=' . $variableList->Id; ?>" style="border-radius:50%" class="btn btn-success">
