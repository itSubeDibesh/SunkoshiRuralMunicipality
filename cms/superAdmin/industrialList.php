            ...
            <tbody>
                ...
                foreach ($industry_info as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="<?php echo CMS_URL . '/' . lcfirst($_SESSION['Role']) . '/industrialAdd.php?id=' . $value->IndustryId; ?>" style="border-radius:50%" class="btn btn-success">
                                <i class="fa fa-edit"></i></a>
                            <a href="<?php echo ADMIN_RENDER . '/common/industrial.php?id=' . $value->IndustryId . '&&Action=Delete'; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this industry?')" style="border-radius: 50%">
